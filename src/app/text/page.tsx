    ...
    <main className="page-shell">
      <header className="page-header">
        <div>
          ...
          <h1 className="page-title">Saved text entries</h1>
      ...
      <section className="glass-panel page-section p-8">
        <div className="section-heading">
          <h2 className="section-title">Add text entry</h2>
          {successMessage && (
      ...
      <section className="page-section">
        <h2 className="section-title">Text entries</h2>

        <div className="card-grid">
          {items.length === 0 ? (
            <div className="card">No text saved yet.</div>
          ) : (
            items.map((item) => (
              <article key={item.id} className="card card-text">
                ...
                <p className="card-value">{item.text}</p>
              </article>
            ))
          )}
        </div>
